        ...
        <div class="row">
            ...
            <div class="col-7 col-sm-9 col-md-9 col-lg-2 align-self-center icons-col text-right">
                    ...
                    <div id="accountBox">
                        <div class="customer-links">
                            <ul class="m-0">
                                ...
                                <li><a href="{{ route('my.account')}}"><i class="icon anm anm-user-cil"></i>My Account</a></li>
                ...
                <div class="header-cart iconset" title="Cart">
                    <a href="#;" class="header-cart btn-minicart clr-none" data-bs-toggle="offcanvas" data-bs-target="#minicart-drawer"><i class="hdr-icon icon anm anm-cart-l"></i><span class="cart-count">{{ $carts->count()}}</span></a>
                </div>
                <!--End Minicart-->
                <!--Mobile Toggle-->
