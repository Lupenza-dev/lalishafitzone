            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                        ...
                        <!--Breadcrumbs-->
                        <div class="breadcrumbs"><a href="{{ route('home')}}" title="Back to the home page">Home</a><span class="title"><i class="icon anm anm-angle-right-l"></i>Pages</span><span class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>My Account</span></div>
                        <!--End Breadcrumbs-->
                    </div>
                </div>
            </div>
                    ...
                    <div class="dashboard-sidebar bg-block">
                        <div class="profile-top text-center mb-4 px-3">
                            <div class="profile-image mb-3">
                                ...
                                <i style="font-size: 90px" class="anm anm-user-cil"></i>
                            </div>
                        ...
                        <div class="tab-pane fade h-100 show active" id="info">
                            <div class="account-info h-100">
                                <div class="welcome-msg mb-4">
                                    ...
                                    <p>From your My Account Dashboard you have the ability to view a snapshot of your recent account activity.</p>
                                </div>
                                ...
                                <div class="row g-3 row-cols-lg-3 row-cols-md-3 row-cols-sm-3 row-cols-1 mb-4">
                                    <div class="counter-box">
                                        <div class="bg-block d-flex-center flex-nowrap">
                                            <img class="blur-up lazyload" data-src="{{ asset('assets/frontend/images/icons/sale.png')}}" src="{{ asset('assets/frontend/images/icons/sale.png')}}" alt="icon" width="64" height="64" />
                                            <div class="content">
                                                <h3 class="fs-5 mb-1 text-primary">{{ number_format($orders->sum('amount'))}}</h3>
                                    ...
                                    <div class="counter-box">
                                        <div class="bg-block d-flex-center flex-nowrap">
                                            <img class="blur-up lazyload" data-src="{{ asset('assets/frontend/images/icons/homework.png')}}" src="{{ asset('assets/frontend/images/icons/homework.png')}}" alt="icon" width="64" height="64" />
                                            <div class="content">
                                                <h3 class="fs-5 mb-1 text-primary">{{ number_format($orders->whereIn('status',[0,2])->sum('amount'))}}</h3>
                                                <p>Pending Orders ({{ number_format($orders->whereIn('status',[0,2])->count())}})</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="counter-box">
                                        <div class="bg-block d-flex-center flex-nowrap">
                                            <img class="blur-up lazyload" data-src="{{ asset('assets/frontend/images/icons/order.png')}}" src="{{ asset('assets/frontend/images/icons/order.png')}}" alt="icon" width="64" height="64" />
                                            <div class="content">
                                                <h3 class="fs-5 mb-1 text-primary">{{ number_format($orders->where('status',1)->sum('amount'))}}</h3>
                                                <p>Completed Order ( {{ number_format($orders->where('status',1)->count())}})</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                        <div class="box-info mb-4">
                                            <div class="box-title d-flex-center">
                                                ...
                                                {{-- <a href="#" class="btn-link ms-auto">Edit</a> --}}
                                            </div>
                                            <div class="box-content mt-3">
                                                <h5>{{ Auth::user()->name }}</h5>
                                                <p class="mb-2">{{ Auth::user()->email }}</p>
                                                <p class="mb-2">Active</a></p>
                                            </div>
                                        </div>
                                        <div class="box-info mb-4">
                                            <div class="box-title d-flex-center">
                                            ...
                                            <div class="box-content mt-3">
                                                ...
                                                <p>You are currently  subscribed to Lalisha newsletter.</p>
                            ...
                            <div class="orders-card mt-0 h-100">    
                                ...
                                <div class="table-bottom-brd table-responsive">
                                    <table class="table align-middle text-center order-table">
                                        ...
                                        <tbody>
                                           @foreach (Auth::user()->paymentLogs as $order)
                                                <tr>
