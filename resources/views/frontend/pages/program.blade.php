...
<div id="page-content"> 
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <!--Breadcrumbs-->
                    <div class="breadcrumbs"><a href="{{ route('home')}}" title="Back to the home page">Home</a><span class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>{{ $program->name }}</span></div>
                    <!--End Breadcrumbs-->
                </div>
            </div>
        </div>
    ...
    <div class="container">     
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
                    <div class="product-sticky-style">
                        ...
                        <div class="social-sharing d-flex-center justify-content-center mt-3 mt-md-4 lh-lg">
                            ...
                            <a href="#" class="d-flex-center btn btn-link btn--share share-pinterest"><i class="icon anm anm-instagram"></i> <span class="share-title">Pin it</span></a>
                        </div>
                        <!-- End Social Sharing -->
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                    <div class="product-wrap-bg text-center">
                        ...
                        <div class="product-single-meta">
                            <h2 class="product-main-title">{{ $program->name }}</h2>
                            <!-- Product Price -->
                            ...
                            <div class="product-review d-flex-center justify-content-center mb-3">
                                <div class="reviewStar d-flex-center"><i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i class="icon anm anm-star-o"></i><span class="caption ms-2"> Reviews</span></div>
                            ...
                            <hr />
                            <!-- Sort Description -->
                            <div class="sort-description mb-3">{{ $program->caption}}</div>
                            ...
                            <div class="product-action w-100 d-flex-wrap justify-content-center mb-2 mb-md-2">
                                ...
                                <div class="product-form-submit addcart fl-1 ms-3">
                                    <a href="{{ route('add.cart',$program->id)}}">
                                        <button type="button" name="add" class="btn btn-secondary product-form-cart-submit">
                                ...
                                <div class="product-form-submit buyit fl-1 ms-3">
                                    <button type="button" class="btn btn-primary proceed-to-checkout"><span>Checkout</span></button>
                                </div>
                                <!-- End Product Buy -->
                            </div>
                            <!-- End Product Action -->
        ...
        <a href="product-layout6.html" class="product-nav prev-pro clr-none d-flex-center justify-content-between" title="Previous Product">
            <span class="details">
                <span class="price">{{ $program->name }}</span>
            </span>
            <span class="img"><img src="{{ asset('storage/uploads'.'/'.$program->cover['cover1'])}}" alt="product" width="120" height="170" /></span>
        </a>
        <a href="product-layout1.html" class="product-nav next-pro clr-none d-flex-center justify-content-between" title="Next Product">
            <span class="img"><img src="{{ asset('storage/uploads'.'/'.$program->cover['cover2'])}}" alt="product" width="120" height="170" /></span>
            <span class="details">
                <span class="name">{{ number_format($program->price) }} Tsh</span>
            </span>
        </a>
        <!--End Product Nav-->
